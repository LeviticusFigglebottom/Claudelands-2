...
const VOICE_TAG: Record<string, string> = {
  ...
  bet: 'precise hushed whisper, dry wit, a forecast officer who has not raised her voice in twenty years',
...
const THUG_TAGS: Record<string, string> = {
  ...
  'I\u2019M ABOUT TO CUM, MON!! OH MI GAAD!!': 'exaggerated thick Jamaican patois accent, ecstatic screaming, drawn out syllables',
  ...
  'I\u2019M ABOUT TO NUT, MON!!': 'exaggerated thick Jamaican patois accent, one triumphant drawn-out scream',
  'I\u2019M ABOUT TO BUS, YA HEAR?!': 'exaggerated thick Jamaican patois accent, one urgent drawn-out shout',
  'I\u2019M ABOUT TO BLOW, BREDRIN!!': 'exaggerated thick Jamaican patois accent, one panicked drawn-out scream',
  'MMMMH!! MMMMMMH!!': 'deep closed-mouth ecstatic moaning, the second longer and higher',
  'UGHHH\u2026 WOOOOO!!': 'a low guttural groan releasing into a delighted whoop',
  'AH\u2014 AH\u2014 AHHHHH!!': 'staccato gasps building into one long ecstatic cry',
  'HOOOO\u2026 HAAAAH\u2026 WOOO!!': 'breathless panting whoops, exhausted and delighted',
};
