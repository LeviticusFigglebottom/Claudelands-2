...
export const RARITIES: Record<string, RarityDef> = {
  ...
  uncommon:  { id: 'uncommon',  name: 'Uncommon',  tier: 1, color: 0x3ddc4e, css: '#3ddc4e', weight: 45,  statMult: 1.12, minGrade: 0, accessoryChance: 0.15, elemChanceBonus: 0.10 },
  rare:      { id: 'rare',      name: 'Rare',      tier: 2, color: 0x2f7dff, css: '#4f95ff', weight: 16,  statMult: 1.26, minGrade: 1, accessoryChance: 0.45, elemChanceBonus: 0.25 },
  epic:      { id: 'epic',      name: 'Epic',      tier: 3, color: 0xb04bff, css: '#c06bff', weight: 5,   statMult: 1.42, minGrade: 1, accessoryChance: 0.80, elemChanceBonus: 0.45 },
  legendary: { id: 'legendary', name: 'Legendary', tier: 4, color: 0xff9500, css: '#ffa21f', weight: 1.1, statMult: 1.60, minGrade: 2, accessoryChance: 1.00, elemChanceBonus: 0.60 },
  // Top tier reserved for future named uniques — the slot machine's jackpot lamp.
  opaline:   { id: 'opaline',   name: 'Opaline',   tier: 5, color: 0x7ffff2, css: '#8ffff4', weight: 0.06, statMult: 1.85, minGrade: 2, accessoryChance: 1.00, elemChanceBonus: 0.80 },
};
