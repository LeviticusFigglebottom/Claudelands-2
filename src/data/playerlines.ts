...
export const THUG_LINES: string[] = [
  ...
  'OHHH I\u2019M FINNA BUST!!',
  'YOU GOT ME TWEAKING OUT MY MIND BRO!!',
  'THE SAUCE!! THE SAUCE IS EVERYWHERE!!',
  'I\u2019M EDGING THE FIGHT OF MY LIFE BRO!!',
  'THUG SHAKE ENGAGED. FULL POWER!!',
  'I CAME, I SAW, I CAME AGAIN!!',
  'MY TOES ARE CURLING BRO!!',
  'THIS LOOT GOT ME LEAKING BRO!!',
  'WHO\u2019S GOONING?! I\u2019M GOONING!!',
  'I\u2019M SO CLOSE. DO NOT STOP SHOOTING!!',
  'BRO I JUST FINISHED\u2026 TWICE!!',
  'GYATT DAMN, SOLDIER!!',
  'Please goon responsibly.',
  'Hydration is the real legendary drop.',
  'Remember to stretch before and after each firefight.',
];
